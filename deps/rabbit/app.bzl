...
def all_beam_files(name = "all_beam_files"):
    ...
    erlang_bytecode(
        ...
        outs = [
            "ebin/gm.beam",
            "ebin/rabbit_backing_queue.beam",
            "ebin/rabbit_credential_validator.beam",
            "ebin/rabbit_exchange_type.beam",
            "ebin/rabbit_mirror_queue_mode.beam",
            "ebin/rabbit_policy_merge_strategy.beam",
            "ebin/rabbit_queue_master_locator.beam",
            "ebin/rabbit_queue_type.beam",
            "ebin/rabbit_tracking.beam",
        ],
        hdrs = [
    ...
    erlang_bytecode(
        ...
        outs = [
            "ebin/amqqueue.beam",
            "ebin/background_gc.beam",
            "ebin/code_server_cache.beam",
            "ebin/gatherer.beam",
            "ebin/internal_user.beam",
            "ebin/lqueue.beam",
            "ebin/mirrored_supervisor.beam",
            "ebin/mirrored_supervisor_sups.beam",
            "ebin/pg_local.beam",
            "ebin/pid_recomposition.beam",
            "ebin/rabbit.beam",
            "ebin/rabbit_access_control.beam",
            "ebin/rabbit_alarm.beam",
            "ebin/rabbit_amqqueue.beam",
            "ebin/rabbit_amqqueue_process.beam",
            "ebin/rabbit_amqqueue_sup.beam",
            "ebin/rabbit_amqqueue_sup_sup.beam",
            "ebin/rabbit_auth_backend_internal.beam",
            "ebin/rabbit_auth_mechanism_amqplain.beam",
            "ebin/rabbit_auth_mechanism_cr_demo.beam",
            "ebin/rabbit_auth_mechanism_plain.beam",
            "ebin/rabbit_autoheal.beam",
            "ebin/rabbit_basic.beam",
            "ebin/rabbit_binding.beam",
            "ebin/rabbit_boot_steps.beam",
            "ebin/rabbit_channel.beam",
            "ebin/rabbit_channel_interceptor.beam",
            "ebin/rabbit_channel_sup.beam",
            "ebin/rabbit_channel_sup_sup.beam",
            "ebin/rabbit_channel_tracking.beam",
            "ebin/rabbit_channel_tracking_handler.beam",
            "ebin/rabbit_classic_queue.beam",
            "ebin/rabbit_classic_queue_index_v2.beam",
            "ebin/rabbit_classic_queue_store_v2.beam",
            "ebin/rabbit_client_sup.beam",
            "ebin/rabbit_config.beam",
            "ebin/rabbit_confirms.beam",
            "ebin/rabbit_connection_helper_sup.beam",
            "ebin/rabbit_connection_sup.beam",
            "ebin/rabbit_connection_tracking.beam",
            "ebin/rabbit_connection_tracking_handler.beam",
            "ebin/rabbit_control_pbe.beam",
            "ebin/rabbit_core_ff.beam",
            "ebin/rabbit_core_metrics_gc.beam",
            "ebin/rabbit_credential_validation.beam",
            "ebin/rabbit_credential_validator_accept_everything.beam",
            "ebin/rabbit_credential_validator_min_password_length.beam",
            "ebin/rabbit_credential_validator_password_regexp.beam",
            "ebin/rabbit_cuttlefish.beam",
            "ebin/rabbit_db.beam",
            "ebin/rabbit_db_binding.beam",
            "ebin/rabbit_db_cluster.beam",
            "ebin/rabbit_db_exchange.beam",
            "ebin/rabbit_db_maintenance.beam",
            "ebin/rabbit_db_msup.beam",
            "ebin/rabbit_db_policy.beam",
            "ebin/rabbit_db_queue.beam",
            "ebin/rabbit_db_rtparams.beam",
            "ebin/rabbit_db_topic_exchange.beam",
            "ebin/rabbit_db_user.beam",
            "ebin/rabbit_db_vhost.beam",
            "ebin/rabbit_dead_letter.beam",
            "ebin/rabbit_definitions.beam",
            "ebin/rabbit_definitions_hashing.beam",
            "ebin/rabbit_definitions_import_https.beam",
            "ebin/rabbit_definitions_import_local_filesystem.beam",
            "ebin/rabbit_diagnostics.beam",
            "ebin/rabbit_direct.beam",
            "ebin/rabbit_direct_reply_to.beam",
            "ebin/rabbit_disk_monitor.beam",
            "ebin/rabbit_epmd_monitor.beam",
            "ebin/rabbit_event_consumer.beam",
            "ebin/rabbit_exchange.beam",
            "ebin/rabbit_exchange_decorator.beam",
            "ebin/rabbit_exchange_parameters.beam",
            "ebin/rabbit_exchange_type_direct.beam",
            "ebin/rabbit_exchange_type_fanout.beam",
            "ebin/rabbit_exchange_type_headers.beam",
            "ebin/rabbit_exchange_type_invalid.beam",
            "ebin/rabbit_exchange_type_topic.beam",
            "ebin/rabbit_feature_flags.beam",
            "ebin/rabbit_ff_controller.beam",
            "ebin/rabbit_ff_extra.beam",
            "ebin/rabbit_ff_registry.beam",
            "ebin/rabbit_ff_registry_factory.beam",
            "ebin/rabbit_fhc_helpers.beam",
            "ebin/rabbit_fifo.beam",
            "ebin/rabbit_fifo_client.beam",
            "ebin/rabbit_fifo_dlx.beam",
            "ebin/rabbit_fifo_dlx_client.beam",
            "ebin/rabbit_fifo_dlx_sup.beam",
            "ebin/rabbit_fifo_dlx_worker.beam",
            "ebin/rabbit_fifo_index.beam",
            "ebin/rabbit_fifo_v0.beam",
            "ebin/rabbit_fifo_v1.beam",
            "ebin/rabbit_file.beam",
            "ebin/rabbit_global_counters.beam",
            "ebin/rabbit_guid.beam",
            "ebin/rabbit_health_check.beam",
            "ebin/rabbit_limiter.beam",
            "ebin/rabbit_log_channel.beam",
            "ebin/rabbit_log_connection.beam",
            "ebin/rabbit_log_mirroring.beam",
            "ebin/rabbit_log_prelaunch.beam",
            "ebin/rabbit_log_queue.beam",
            "ebin/rabbit_log_tail.beam",
            "ebin/rabbit_logger_exchange_h.beam",
            "ebin/rabbit_looking_glass.beam",
            "ebin/rabbit_maintenance.beam",
            "ebin/rabbit_memory_monitor.beam",
            "ebin/rabbit_metrics.beam",
            "ebin/rabbit_mirror_queue_coordinator.beam",
            "ebin/rabbit_mirror_queue_master.beam",
            "ebin/rabbit_mirror_queue_misc.beam",
            "ebin/rabbit_mirror_queue_mode_all.beam",
            "ebin/rabbit_mirror_queue_mode_exactly.beam",
            "ebin/rabbit_mirror_queue_mode_nodes.beam",
            "ebin/rabbit_mirror_queue_slave.beam",
            "ebin/rabbit_mirror_queue_sync.beam",
            "ebin/rabbit_mnesia.beam",
            "ebin/rabbit_mnesia_rename.beam",
            "ebin/rabbit_msg_file.beam",
            "ebin/rabbit_msg_record.beam",
            "ebin/rabbit_msg_store.beam",
            "ebin/rabbit_msg_store_ets_index.beam",
            "ebin/rabbit_msg_store_gc.beam",
            "ebin/rabbit_networking.beam",
            "ebin/rabbit_networking_store.beam",
            "ebin/rabbit_node_monitor.beam",
            "ebin/rabbit_nodes.beam",
            "ebin/rabbit_observer_cli.beam",
            "ebin/rabbit_observer_cli_classic_queues.beam",
            "ebin/rabbit_osiris_metrics.beam",
            "ebin/rabbit_parameter_validation.beam",
            ...
            "ebin/rabbit_peer_discovery.beam",
            "ebin/rabbit_peer_discovery_classic_config.beam",
            "ebin/rabbit_peer_discovery_dns.beam",
            "ebin/rabbit_plugins.beam",
            "ebin/rabbit_policies.beam",
            "ebin/rabbit_policy.beam",
            "ebin/rabbit_prelaunch_cluster.beam",
            "ebin/rabbit_prelaunch_enabled_plugins_file.beam",
            "ebin/rabbit_prelaunch_feature_flags.beam",
            "ebin/rabbit_prelaunch_logging.beam",
            "ebin/rabbit_prequeue.beam",
            "ebin/rabbit_priority_queue.beam",
            "ebin/rabbit_process.beam",
            "ebin/rabbit_queue_consumers.beam",
            "ebin/rabbit_queue_decorator.beam",
            "ebin/rabbit_queue_index.beam",
            "ebin/rabbit_queue_location.beam",
            "ebin/rabbit_queue_location_client_local.beam",
            "ebin/rabbit_queue_location_min_masters.beam",
            "ebin/rabbit_queue_location_random.beam",
            "ebin/rabbit_queue_location_validator.beam",
            "ebin/rabbit_queue_master_location_misc.beam",
            "ebin/rabbit_queue_type_util.beam",
            "ebin/rabbit_quorum_memory_manager.beam",
            "ebin/rabbit_quorum_queue.beam",
            "ebin/rabbit_ra_registry.beam",
            "ebin/rabbit_ra_systems.beam",
            "ebin/rabbit_reader.beam",
            "ebin/rabbit_recovery_terms.beam",
            "ebin/rabbit_release_series.beam",
            "ebin/rabbit_restartable_sup.beam",
            "ebin/rabbit_router.beam",
            "ebin/rabbit_runtime_parameters.beam",
            "ebin/rabbit_ssl.beam",
            "ebin/rabbit_stream_coordinator.beam",
            "ebin/rabbit_stream_queue.beam",
            "ebin/rabbit_stream_sac_coordinator.beam",
            "ebin/rabbit_sup.beam",
            "ebin/rabbit_sysmon_handler.beam",
            "ebin/rabbit_sysmon_minder.beam",
            "ebin/rabbit_table.beam",
            "ebin/rabbit_time_travel_dbg.beam",
            "ebin/rabbit_trace.beam",
            "ebin/rabbit_tracking_store.beam",
            "ebin/rabbit_upgrade_preparation.beam",
            "ebin/rabbit_variable_queue.beam",
            "ebin/rabbit_version.beam",
            "ebin/rabbit_vhost.beam",
            "ebin/rabbit_vhost_limit.beam",
            "ebin/rabbit_vhost_msg_store.beam",
            "ebin/rabbit_vhost_process.beam",
            "ebin/rabbit_vhost_sup.beam",
            "ebin/rabbit_vhost_sup_sup.beam",
            "ebin/rabbit_vhost_sup_wrapper.beam",
            "ebin/rabbit_vm.beam",
            "ebin/supervised_lifecycle.beam",
            "ebin/tcp_listener.beam",
            "ebin/tcp_listener_sup.beam",
            "ebin/term_to_binary_compat.beam",
            "ebin/vhost.beam",
        ],
        hdrs = [
            "include/amqqueue.hrl",
...
def all_test_beam_files(name = "all_test_beam_files"):
    ...
    erlang_bytecode(
        ...
        outs = [
            "test/gm.beam",
            "test/rabbit_backing_queue.beam",
            "test/rabbit_credential_validator.beam",
            "test/rabbit_exchange_type.beam",
            "test/rabbit_mirror_queue_mode.beam",
            "test/rabbit_policy_merge_strategy.beam",
            "test/rabbit_queue_master_locator.beam",
            "test/rabbit_queue_type.beam",
            "test/rabbit_tracking.beam",
        ],
        hdrs = [
            "include/amqqueue.hrl",
            "include/amqqueue_v2.hrl",
    ...
    erlang_bytecode(
        ...
        outs = [
            "test/amqqueue.beam",
            "test/background_gc.beam",
            "test/code_server_cache.beam",
            "test/gatherer.beam",
            "test/internal_user.beam",
            "test/lqueue.beam",
            "test/mirrored_supervisor.beam",
            "test/mirrored_supervisor_sups.beam",
            "test/pg_local.beam",
            "test/pid_recomposition.beam",
            "test/rabbit.beam",
            "test/rabbit_access_control.beam",
            "test/rabbit_alarm.beam",
            "test/rabbit_amqqueue.beam",
            "test/rabbit_amqqueue_process.beam",
            "test/rabbit_amqqueue_sup.beam",
            "test/rabbit_amqqueue_sup_sup.beam",
            "test/rabbit_auth_backend_internal.beam",
            "test/rabbit_auth_mechanism_amqplain.beam",
            "test/rabbit_auth_mechanism_cr_demo.beam",
            "test/rabbit_auth_mechanism_plain.beam",
            "test/rabbit_autoheal.beam",
            "test/rabbit_basic.beam",
            "test/rabbit_binding.beam",
            "test/rabbit_boot_steps.beam",
            "test/rabbit_channel.beam",
            "test/rabbit_channel_interceptor.beam",
            "test/rabbit_channel_sup.beam",
            "test/rabbit_channel_sup_sup.beam",
            "test/rabbit_channel_tracking.beam",
            "test/rabbit_channel_tracking_handler.beam",
            "test/rabbit_classic_queue.beam",
            "test/rabbit_classic_queue_index_v2.beam",
            "test/rabbit_classic_queue_store_v2.beam",
            "test/rabbit_client_sup.beam",
            "test/rabbit_config.beam",
            "test/rabbit_confirms.beam",
            "test/rabbit_connection_helper_sup.beam",
            "test/rabbit_connection_sup.beam",
            "test/rabbit_connection_tracking.beam",
            "test/rabbit_connection_tracking_handler.beam",
            "test/rabbit_control_pbe.beam",
            "test/rabbit_core_ff.beam",
            "test/rabbit_core_metrics_gc.beam",
            "test/rabbit_credential_validation.beam",
            "test/rabbit_credential_validator_accept_everything.beam",
            "test/rabbit_credential_validator_min_password_length.beam",
            "test/rabbit_credential_validator_password_regexp.beam",
            "test/rabbit_cuttlefish.beam",
            "test/rabbit_db.beam",
            "test/rabbit_db_binding.beam",
            "test/rabbit_db_cluster.beam",
            "test/rabbit_db_exchange.beam",
            "test/rabbit_db_maintenance.beam",
            "test/rabbit_db_msup.beam",
            "test/rabbit_db_policy.beam",
            "test/rabbit_db_queue.beam",
            "test/rabbit_db_rtparams.beam",
            "test/rabbit_db_topic_exchange.beam",
            "test/rabbit_db_user.beam",
            "test/rabbit_db_vhost.beam",
            "test/rabbit_dead_letter.beam",
            "test/rabbit_definitions.beam",
            "test/rabbit_definitions_hashing.beam",
            "test/rabbit_definitions_import_https.beam",
            "test/rabbit_definitions_import_local_filesystem.beam",
            "test/rabbit_diagnostics.beam",
            "test/rabbit_direct.beam",
            "test/rabbit_direct_reply_to.beam",
            "test/rabbit_disk_monitor.beam",
            "test/rabbit_epmd_monitor.beam",
            "test/rabbit_event_consumer.beam",
            "test/rabbit_exchange.beam",
            "test/rabbit_exchange_decorator.beam",
            "test/rabbit_exchange_parameters.beam",
            "test/rabbit_exchange_type_direct.beam",
            "test/rabbit_exchange_type_fanout.beam",
            "test/rabbit_exchange_type_headers.beam",
            "test/rabbit_exchange_type_invalid.beam",
            "test/rabbit_exchange_type_topic.beam",
            "test/rabbit_feature_flags.beam",
            "test/rabbit_ff_controller.beam",
            "test/rabbit_ff_extra.beam",
            "test/rabbit_ff_registry.beam",
            "test/rabbit_ff_registry_factory.beam",
            "test/rabbit_fhc_helpers.beam",
            "test/rabbit_fifo.beam",
            "test/rabbit_fifo_client.beam",
            "test/rabbit_fifo_dlx.beam",
            "test/rabbit_fifo_dlx_client.beam",
            "test/rabbit_fifo_dlx_sup.beam",
            "test/rabbit_fifo_dlx_worker.beam",
            "test/rabbit_fifo_index.beam",
            "test/rabbit_fifo_v0.beam",
            "test/rabbit_fifo_v1.beam",
            "test/rabbit_file.beam",
            "test/rabbit_global_counters.beam",
            "test/rabbit_guid.beam",
            "test/rabbit_health_check.beam",
            "test/rabbit_limiter.beam",
            "test/rabbit_log_channel.beam",
            "test/rabbit_log_connection.beam",
            "test/rabbit_log_mirroring.beam",
            "test/rabbit_log_prelaunch.beam",
            "test/rabbit_log_queue.beam",
            "test/rabbit_log_tail.beam",
            "test/rabbit_logger_exchange_h.beam",
            "test/rabbit_looking_glass.beam",
            "test/rabbit_maintenance.beam",
            "test/rabbit_memory_monitor.beam",
            "test/rabbit_metrics.beam",
            "test/rabbit_mirror_queue_coordinator.beam",
            "test/rabbit_mirror_queue_master.beam",
            "test/rabbit_mirror_queue_misc.beam",
            "test/rabbit_mirror_queue_mode_all.beam",
            "test/rabbit_mirror_queue_mode_exactly.beam",
            "test/rabbit_mirror_queue_mode_nodes.beam",
            "test/rabbit_mirror_queue_slave.beam",
            "test/rabbit_mirror_queue_sync.beam",
            "test/rabbit_mnesia.beam",
            "test/rabbit_mnesia_rename.beam",
            "test/rabbit_msg_file.beam",
            "test/rabbit_msg_record.beam",
            "test/rabbit_msg_store.beam",
            "test/rabbit_msg_store_ets_index.beam",
            "test/rabbit_msg_store_gc.beam",
            "test/rabbit_networking.beam",
            "test/rabbit_networking_store.beam",
            "test/rabbit_node_monitor.beam",
            "test/rabbit_nodes.beam",
            "test/rabbit_observer_cli.beam",
            "test/rabbit_observer_cli_classic_queues.beam",
            "test/rabbit_osiris_metrics.beam",
            "test/rabbit_parameter_validation.beam",
            ...
            "test/rabbit_peer_discovery.beam",
            "test/rabbit_peer_discovery_classic_config.beam",
            "test/rabbit_peer_discovery_dns.beam",
            "test/rabbit_plugins.beam",
            "test/rabbit_policies.beam",
            "test/rabbit_policy.beam",
            "test/rabbit_prelaunch_cluster.beam",
            "test/rabbit_prelaunch_enabled_plugins_file.beam",
            "test/rabbit_prelaunch_feature_flags.beam",
            "test/rabbit_prelaunch_logging.beam",
            "test/rabbit_prequeue.beam",
            "test/rabbit_priority_queue.beam",
            "test/rabbit_process.beam",
            "test/rabbit_queue_consumers.beam",
            "test/rabbit_queue_decorator.beam",
            "test/rabbit_queue_index.beam",
            "test/rabbit_queue_location.beam",
            "test/rabbit_queue_location_client_local.beam",
            "test/rabbit_queue_location_min_masters.beam",
            "test/rabbit_queue_location_random.beam",
            "test/rabbit_queue_location_validator.beam",
            "test/rabbit_queue_master_location_misc.beam",
            "test/rabbit_queue_type_util.beam",
            "test/rabbit_quorum_memory_manager.beam",
            "test/rabbit_quorum_queue.beam",
            "test/rabbit_ra_registry.beam",
            "test/rabbit_ra_systems.beam",
            "test/rabbit_reader.beam",
            "test/rabbit_recovery_terms.beam",
            "test/rabbit_release_series.beam",
            "test/rabbit_restartable_sup.beam",
            "test/rabbit_router.beam",
            "test/rabbit_runtime_parameters.beam",
            "test/rabbit_ssl.beam",
            "test/rabbit_stream_coordinator.beam",
            "test/rabbit_stream_queue.beam",
            "test/rabbit_stream_sac_coordinator.beam",
            "test/rabbit_sup.beam",
            "test/rabbit_sysmon_handler.beam",
            "test/rabbit_sysmon_minder.beam",
            "test/rabbit_table.beam",
            "test/rabbit_time_travel_dbg.beam",
            "test/rabbit_trace.beam",
            "test/rabbit_tracking_store.beam",
            "test/rabbit_upgrade_preparation.beam",
            "test/rabbit_variable_queue.beam",
            "test/rabbit_version.beam",
            "test/rabbit_vhost.beam",
            "test/rabbit_vhost_limit.beam",
            "test/rabbit_vhost_msg_store.beam",
            "test/rabbit_vhost_process.beam",
            "test/rabbit_vhost_sup.beam",
            "test/rabbit_vhost_sup_sup.beam",
            "test/rabbit_vhost_sup_wrapper.beam",
            "test/rabbit_vm.beam",
            "test/supervised_lifecycle.beam",
            "test/tcp_listener.beam",
            "test/tcp_listener_sup.beam",
            "test/term_to_binary_compat.beam",
            "test/vhost.beam",
        ],
        hdrs = [
            "include/amqqueue.hrl",
