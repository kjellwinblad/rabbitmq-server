...
def all_beam_files(name = "all_beam_files"):
    ...
    erlang_bytecode(
        ...
        outs = [
            "ebin/rabbit_db_jms_exchange.beam",
            "ebin/rabbit_jms_topic_exchange.beam",
            "ebin/sjx_evaluator.beam",
        ],
...
def all_test_beam_files(name = "all_test_beam_files"):
    ...
    erlang_bytecode(
        ...
        outs = [
            "test/rabbit_db_jms_exchange.beam",
            "test/rabbit_jms_topic_exchange.beam",
            "test/sjx_evaluator.beam",
        ],
        hdrs = ["include/rabbit_jms_topic_exchange.hrl"],
        app_name = "rabbitmq_jms_topic_exchange",
