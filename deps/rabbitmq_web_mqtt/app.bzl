...
def all_beam_files(name = "all_beam_files"):
    ...
    erlang_bytecode(
        ...
        outs = [
            "ebin/rabbit_web_mqtt_app.beam",
            "ebin/rabbit_web_mqtt_handler.beam",
            "ebin/rabbit_web_mqtt_stream_handler.beam",
        ],
...
def all_test_beam_files(name = "all_test_beam_files"):
    ...
    erlang_bytecode(
        ...
        outs = [
            "test/rabbit_web_mqtt_app.beam",
            "test/rabbit_web_mqtt_handler.beam",
            "test/rabbit_web_mqtt_stream_handler.beam",
        ],
        app_name = "rabbitmq_web_mqtt",
