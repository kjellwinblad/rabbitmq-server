...
def all_beam_files(name = "all_beam_files"):
    ...
    erlang_bytecode(
        ...
        outs = [
            "ebin/rabbit_peer_discovery_consul.beam",
            "ebin/rabbitmq_peer_discovery_consul.beam",
            "ebin/rabbitmq_peer_discovery_consul_app.beam",
            "ebin/rabbitmq_peer_discovery_consul_health_check_helper.beam",
            "ebin/rabbitmq_peer_discovery_consul_sup.beam",
        ],
...
def all_test_beam_files(name = "all_test_beam_files"):
    ...
    erlang_bytecode(
        ...
        outs = [
            "test/rabbit_peer_discovery_consul.beam",
            "test/rabbitmq_peer_discovery_consul.beam",
            "test/rabbitmq_peer_discovery_consul_app.beam",
            "test/rabbitmq_peer_discovery_consul_health_check_helper.beam",
            "test/rabbitmq_peer_discovery_consul_sup.beam",
        ],
        hdrs = ["include/rabbit_peer_discovery_consul.hrl"],
        app_name = "rabbitmq_peer_discovery_consul",
