...
def all_beam_files(name = "all_beam_files"):
    ...
    erlang_bytecode(
        ...
        outs = [
            "ebin/rabbit_mgmt_app.beam",
            "ebin/rabbit_mgmt_cors.beam",
            "ebin/rabbit_mgmt_csp.beam",
            "ebin/rabbit_mgmt_db.beam",
            "ebin/rabbit_mgmt_db_cache.beam",
            "ebin/rabbit_mgmt_db_cache_sup.beam",
            "ebin/rabbit_mgmt_dispatcher.beam",
            "ebin/rabbit_mgmt_features.beam",
            "ebin/rabbit_mgmt_headers.beam",
            "ebin/rabbit_mgmt_hsts.beam",
            "ebin/rabbit_mgmt_load_definitions.beam",
            "ebin/rabbit_mgmt_login.beam",
            "ebin/rabbit_mgmt_reset_handler.beam",
            "ebin/rabbit_mgmt_stats.beam",
            "ebin/rabbit_mgmt_sup.beam",
            "ebin/rabbit_mgmt_sup_sup.beam",
            "ebin/rabbit_mgmt_util.beam",
            "ebin/rabbit_mgmt_wm_aliveness_test.beam",
            "ebin/rabbit_mgmt_wm_auth.beam",
            "ebin/rabbit_mgmt_wm_auth_attempts.beam",
            "ebin/rabbit_mgmt_wm_binding.beam",
            "ebin/rabbit_mgmt_wm_bindings.beam",
            "ebin/rabbit_mgmt_wm_channel.beam",
            "ebin/rabbit_mgmt_wm_channels.beam",
            "ebin/rabbit_mgmt_wm_channels_vhost.beam",
            "ebin/rabbit_mgmt_wm_cluster_name.beam",
            "ebin/rabbit_mgmt_wm_connection.beam",
            "ebin/rabbit_mgmt_wm_connection_channels.beam",
            "ebin/rabbit_mgmt_wm_connection_user_name.beam",
            "ebin/rabbit_mgmt_wm_connections.beam",
            "ebin/rabbit_mgmt_wm_connections_vhost.beam",
            "ebin/rabbit_mgmt_wm_consumers.beam",
            "ebin/rabbit_mgmt_wm_definitions.beam",
            "ebin/rabbit_mgmt_wm_environment.beam",
            "ebin/rabbit_mgmt_wm_exchange.beam",
            "ebin/rabbit_mgmt_wm_exchange_publish.beam",
            "ebin/rabbit_mgmt_wm_exchanges.beam",
            "ebin/rabbit_mgmt_wm_extensions.beam",
            "ebin/rabbit_mgmt_wm_feature_flag_enable.beam",
            "ebin/rabbit_mgmt_wm_feature_flags.beam",
            "ebin/rabbit_mgmt_wm_global_parameter.beam",
            "ebin/rabbit_mgmt_wm_global_parameters.beam",
            "ebin/rabbit_mgmt_wm_hash_password.beam",
            "ebin/rabbit_mgmt_wm_health_check_alarms.beam",
            "ebin/rabbit_mgmt_wm_health_check_certificate_expiration.beam",
            "ebin/rabbit_mgmt_wm_health_check_local_alarms.beam",
            "ebin/rabbit_mgmt_wm_health_check_node_is_mirror_sync_critical.beam",
            "ebin/rabbit_mgmt_wm_health_check_node_is_quorum_critical.beam",
            "ebin/rabbit_mgmt_wm_health_check_port_listener.beam",
            "ebin/rabbit_mgmt_wm_health_check_protocol_listener.beam",
            "ebin/rabbit_mgmt_wm_health_check_virtual_hosts.beam",
            "ebin/rabbit_mgmt_wm_healthchecks.beam",
            "ebin/rabbit_mgmt_wm_limit.beam",
            "ebin/rabbit_mgmt_wm_limits.beam",
            "ebin/rabbit_mgmt_wm_login.beam",
            "ebin/rabbit_mgmt_wm_node.beam",
            "ebin/rabbit_mgmt_wm_node_memory.beam",
            "ebin/rabbit_mgmt_wm_node_memory_ets.beam",
            "ebin/rabbit_mgmt_wm_nodes.beam",
            "ebin/rabbit_mgmt_wm_operator_policies.beam",
            "ebin/rabbit_mgmt_wm_operator_policy.beam",
            "ebin/rabbit_mgmt_wm_overview.beam",
            "ebin/rabbit_mgmt_wm_parameter.beam",
            "ebin/rabbit_mgmt_wm_parameters.beam",
            "ebin/rabbit_mgmt_wm_permission.beam",
            "ebin/rabbit_mgmt_wm_permissions.beam",
            "ebin/rabbit_mgmt_wm_permissions_user.beam",
            "ebin/rabbit_mgmt_wm_permissions_vhost.beam",
            "ebin/rabbit_mgmt_wm_policies.beam",
            "ebin/rabbit_mgmt_wm_policy.beam",
            "ebin/rabbit_mgmt_wm_queue.beam",
            "ebin/rabbit_mgmt_wm_queue_actions.beam",
            "ebin/rabbit_mgmt_wm_queue_get.beam",
            "ebin/rabbit_mgmt_wm_queue_purge.beam",
            "ebin/rabbit_mgmt_wm_queues.beam",
            "ebin/rabbit_mgmt_wm_rebalance_queues.beam",
            "ebin/rabbit_mgmt_wm_redirect.beam",
            "ebin/rabbit_mgmt_wm_reset.beam",
            "ebin/rabbit_mgmt_wm_static.beam",
            "ebin/rabbit_mgmt_wm_topic_permission.beam",
            "ebin/rabbit_mgmt_wm_topic_permissions.beam",
            "ebin/rabbit_mgmt_wm_topic_permissions_user.beam",
            "ebin/rabbit_mgmt_wm_topic_permissions_vhost.beam",
            "ebin/rabbit_mgmt_wm_user.beam",
            "ebin/rabbit_mgmt_wm_user_limit.beam",
            "ebin/rabbit_mgmt_wm_user_limits.beam",
            "ebin/rabbit_mgmt_wm_users.beam",
            "ebin/rabbit_mgmt_wm_users_bulk_delete.beam",
            "ebin/rabbit_mgmt_wm_vhost.beam",
            "ebin/rabbit_mgmt_wm_vhost_restart.beam",
            "ebin/rabbit_mgmt_wm_vhosts.beam",
            "ebin/rabbit_mgmt_wm_whoami.beam",
        ],
        hdrs = ["include/rabbit_mgmt.hrl"],
        app_name = "rabbitmq_management",
        beam = [":behaviours"],
...
def all_test_beam_files(name = "all_test_beam_files"):
    ...
    erlang_bytecode(
        ...
        outs = [
            "test/rabbit_mgmt_app.beam",
            "test/rabbit_mgmt_cors.beam",
            "test/rabbit_mgmt_csp.beam",
            "test/rabbit_mgmt_db.beam",
            "test/rabbit_mgmt_db_cache.beam",
            "test/rabbit_mgmt_db_cache_sup.beam",
            "test/rabbit_mgmt_dispatcher.beam",
            "test/rabbit_mgmt_features.beam",
            "test/rabbit_mgmt_headers.beam",
            "test/rabbit_mgmt_hsts.beam",
            "test/rabbit_mgmt_load_definitions.beam",
            "test/rabbit_mgmt_login.beam",
            "test/rabbit_mgmt_reset_handler.beam",
            "test/rabbit_mgmt_stats.beam",
            "test/rabbit_mgmt_sup.beam",
            "test/rabbit_mgmt_sup_sup.beam",
            "test/rabbit_mgmt_util.beam",
            "test/rabbit_mgmt_wm_aliveness_test.beam",
            "test/rabbit_mgmt_wm_auth.beam",
            "test/rabbit_mgmt_wm_auth_attempts.beam",
            "test/rabbit_mgmt_wm_binding.beam",
            "test/rabbit_mgmt_wm_bindings.beam",
            "test/rabbit_mgmt_wm_channel.beam",
            "test/rabbit_mgmt_wm_channels.beam",
            "test/rabbit_mgmt_wm_channels_vhost.beam",
            "test/rabbit_mgmt_wm_cluster_name.beam",
            "test/rabbit_mgmt_wm_connection.beam",
            "test/rabbit_mgmt_wm_connection_channels.beam",
            "test/rabbit_mgmt_wm_connection_user_name.beam",
            "test/rabbit_mgmt_wm_connections.beam",
            "test/rabbit_mgmt_wm_connections_vhost.beam",
            "test/rabbit_mgmt_wm_consumers.beam",
            "test/rabbit_mgmt_wm_definitions.beam",
            "test/rabbit_mgmt_wm_environment.beam",
            "test/rabbit_mgmt_wm_exchange.beam",
            "test/rabbit_mgmt_wm_exchange_publish.beam",
            "test/rabbit_mgmt_wm_exchanges.beam",
            "test/rabbit_mgmt_wm_extensions.beam",
            "test/rabbit_mgmt_wm_feature_flag_enable.beam",
            "test/rabbit_mgmt_wm_feature_flags.beam",
            "test/rabbit_mgmt_wm_global_parameter.beam",
            "test/rabbit_mgmt_wm_global_parameters.beam",
            "test/rabbit_mgmt_wm_hash_password.beam",
            "test/rabbit_mgmt_wm_health_check_alarms.beam",
            "test/rabbit_mgmt_wm_health_check_certificate_expiration.beam",
            "test/rabbit_mgmt_wm_health_check_local_alarms.beam",
            "test/rabbit_mgmt_wm_health_check_node_is_mirror_sync_critical.beam",
            "test/rabbit_mgmt_wm_health_check_node_is_quorum_critical.beam",
            "test/rabbit_mgmt_wm_health_check_port_listener.beam",
            "test/rabbit_mgmt_wm_health_check_protocol_listener.beam",
            "test/rabbit_mgmt_wm_health_check_virtual_hosts.beam",
            "test/rabbit_mgmt_wm_healthchecks.beam",
            "test/rabbit_mgmt_wm_limit.beam",
            "test/rabbit_mgmt_wm_limits.beam",
            "test/rabbit_mgmt_wm_login.beam",
            "test/rabbit_mgmt_wm_node.beam",
            "test/rabbit_mgmt_wm_node_memory.beam",
            "test/rabbit_mgmt_wm_node_memory_ets.beam",
            "test/rabbit_mgmt_wm_nodes.beam",
            "test/rabbit_mgmt_wm_operator_policies.beam",
            "test/rabbit_mgmt_wm_operator_policy.beam",
            "test/rabbit_mgmt_wm_overview.beam",
            "test/rabbit_mgmt_wm_parameter.beam",
            "test/rabbit_mgmt_wm_parameters.beam",
            "test/rabbit_mgmt_wm_permission.beam",
            "test/rabbit_mgmt_wm_permissions.beam",
            "test/rabbit_mgmt_wm_permissions_user.beam",
            "test/rabbit_mgmt_wm_permissions_vhost.beam",
            "test/rabbit_mgmt_wm_policies.beam",
            "test/rabbit_mgmt_wm_policy.beam",
            "test/rabbit_mgmt_wm_queue.beam",
            "test/rabbit_mgmt_wm_queue_actions.beam",
            "test/rabbit_mgmt_wm_queue_get.beam",
            "test/rabbit_mgmt_wm_queue_purge.beam",
            "test/rabbit_mgmt_wm_queues.beam",
            "test/rabbit_mgmt_wm_rebalance_queues.beam",
            "test/rabbit_mgmt_wm_redirect.beam",
            "test/rabbit_mgmt_wm_reset.beam",
            "test/rabbit_mgmt_wm_static.beam",
            "test/rabbit_mgmt_wm_topic_permission.beam",
            "test/rabbit_mgmt_wm_topic_permissions.beam",
            "test/rabbit_mgmt_wm_topic_permissions_user.beam",
            "test/rabbit_mgmt_wm_topic_permissions_vhost.beam",
            "test/rabbit_mgmt_wm_user.beam",
            "test/rabbit_mgmt_wm_user_limit.beam",
            "test/rabbit_mgmt_wm_user_limits.beam",
            "test/rabbit_mgmt_wm_users.beam",
            "test/rabbit_mgmt_wm_users_bulk_delete.beam",
            "test/rabbit_mgmt_wm_vhost.beam",
            "test/rabbit_mgmt_wm_vhost_restart.beam",
            "test/rabbit_mgmt_wm_vhosts.beam",
            "test/rabbit_mgmt_wm_whoami.beam",
        ],
        hdrs = ["include/rabbit_mgmt.hrl"],
        app_name = "rabbitmq_management",
