...
RABBITMQ_CONFIG_FILENAME=rabbitmq-idp-initiated-with-prefix-via-proxy.config

# RABBITMQ_URL is used by fakeproxy 
RABBITMQ_URL=http://rabbitmq:15672/
FAKE_PROXY_URL=http://fakeproxy:3000/my-prefix/another-prefix/
