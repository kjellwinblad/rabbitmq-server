...
def all_beam_files(name = "all_beam_files"):
    ...
    erlang_bytecode(
        ...
        outs = [
            "ebin/Elixir.RabbitMQ.CLI.Ctl.Commands.FederationStatusCommand.beam",
            "ebin/Elixir.RabbitMQ.CLI.Ctl.Commands.RestartFederationLinkCommand.beam",
            "ebin/rabbit_federation_app.beam",
            "ebin/rabbit_federation_db.beam",
            "ebin/rabbit_federation_event.beam",
            "ebin/rabbit_federation_exchange.beam",
            "ebin/rabbit_federation_exchange_link.beam",
            "ebin/rabbit_federation_exchange_link_sup_sup.beam",
            "ebin/rabbit_federation_link_sup.beam",
            "ebin/rabbit_federation_link_util.beam",
            "ebin/rabbit_federation_parameters.beam",
            "ebin/rabbit_federation_pg.beam",
            "ebin/rabbit_federation_queue.beam",
            "ebin/rabbit_federation_queue_link.beam",
            "ebin/rabbit_federation_queue_link_sup_sup.beam",
            "ebin/rabbit_federation_status.beam",
            "ebin/rabbit_federation_sup.beam",
            "ebin/rabbit_federation_upstream.beam",
            "ebin/rabbit_federation_upstream_exchange.beam",
            "ebin/rabbit_federation_util.beam",
            "ebin/rabbit_log_federation.beam",
        ],
        hdrs = [
            "include/logging.hrl",
...
def all_test_beam_files(name = "all_test_beam_files"):
    ...
    erlang_bytecode(
        ...
        outs = [
            "test/Elixir.RabbitMQ.CLI.Ctl.Commands.FederationStatusCommand.beam",
            "test/Elixir.RabbitMQ.CLI.Ctl.Commands.RestartFederationLinkCommand.beam",
            "test/rabbit_federation_app.beam",
            "test/rabbit_federation_db.beam",
            "test/rabbit_federation_event.beam",
            "test/rabbit_federation_exchange.beam",
            "test/rabbit_federation_exchange_link.beam",
            "test/rabbit_federation_exchange_link_sup_sup.beam",
            "test/rabbit_federation_link_sup.beam",
            "test/rabbit_federation_link_util.beam",
            "test/rabbit_federation_parameters.beam",
            "test/rabbit_federation_pg.beam",
            "test/rabbit_federation_queue.beam",
            "test/rabbit_federation_queue_link.beam",
            "test/rabbit_federation_queue_link_sup_sup.beam",
            "test/rabbit_federation_status.beam",
            "test/rabbit_federation_sup.beam",
            "test/rabbit_federation_upstream.beam",
            "test/rabbit_federation_upstream_exchange.beam",
            "test/rabbit_federation_util.beam",
            "test/rabbit_log_federation.beam",
        ],
        hdrs = [
            "include/logging.hrl",
            "include/rabbit_federation.hrl",
