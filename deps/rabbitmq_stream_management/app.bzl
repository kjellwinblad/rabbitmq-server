...
def all_beam_files(name = "all_beam_files"):
    ...
    erlang_bytecode(
        ...
        outs = [
            "ebin/rabbit_stream_connection_consumers_mgmt.beam",
            "ebin/rabbit_stream_connection_mgmt.beam",
            "ebin/rabbit_stream_connection_publishers_mgmt.beam",
            "ebin/rabbit_stream_connections_mgmt.beam",
            "ebin/rabbit_stream_connections_vhost_mgmt.beam",
            "ebin/rabbit_stream_consumers_mgmt.beam",
            "ebin/rabbit_stream_management_utils.beam",
            "ebin/rabbit_stream_mgmt_db.beam",
            "ebin/rabbit_stream_publishers_mgmt.beam",
        ],
...
def all_test_beam_files(name = "all_test_beam_files"):
    ...
    erlang_bytecode(
        ...
        outs = [
            "test/rabbit_stream_connection_consumers_mgmt.beam",
            "test/rabbit_stream_connection_mgmt.beam",
            "test/rabbit_stream_connection_publishers_mgmt.beam",
            "test/rabbit_stream_connections_mgmt.beam",
            "test/rabbit_stream_connections_vhost_mgmt.beam",
            "test/rabbit_stream_consumers_mgmt.beam",
            "test/rabbit_stream_management_utils.beam",
            "test/rabbit_stream_mgmt_db.beam",
            "test/rabbit_stream_publishers_mgmt.beam",
        ],
        app_name = "rabbitmq_stream_management",
